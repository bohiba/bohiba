            ...
            children: [
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      BohibaMarqueeText(
                                        ...
                                        text: controller.driverModel.value
                                                .profile?.name ??
                                            '',
                                        overflowText: controller.driverModel
                                                .value.profile?.name ??
                                            '',
                                        style:
                                            bohibaTheme.textTheme.headlineSmall,
                                        marqueeTextStyle:
                                            bohibaTheme.textTheme.headlineSmall,
                                      ),
                                      Text(
                              ...
                              Padding(
                                padding:
                                    EdgeInsets.only(top: ScreenUtils.height20),
                                child: Text(
                                  'Basic Info',
                              ...
                              Padding(
                                padding:
                                    EdgeInsets.only(top: ScreenUtils.height30),
                                child: Text(
                              ...
                              LinearBoxWidget(
                                ...
                                title: controller.driverModel.value
                                    .licenseDetail?.licenseNumber,
                              ),
                              LinearBoxWidget(
                                header: 'License Status',
                                title: controller.driverModel.value
                                    .licenseDetail?.status?.capitalizeFirst,
                              ),
                              LinearBoxWidget(
                                header: 'COV',
                                title: '',
                              ...
                              LinearBoxWidget(
                                header: 'Issued',
                                title: controller.driverModel.value
                                    .licenseDetail?.validityFrom,
                              ),
                              LinearBoxWidget(
                                header: 'Expiry',
                                title: controller.driverModel.value
                                    .licenseDetail?.validityTill,
                              ),
                            ],
                          ),
                        ),
                        Visibility(
                          visible: controller.driverModel.value.rating ==
                                      null ||
                        ...
                        Container(
                          padding:
                              EdgeInsets.only(bottom: ScreenUtils.height25),
                          alignment: Alignment.center,
              ...
              if (controller.didReviewed.isTrue)
                ...
                Padding(
                  ...
                  child: PrimaryButton(
                    onPressed: () {
                      navigate.pushNamed(AppRoute.ratingDriver).then((onValue) {
                        if (onValue != null) {
                          controller.isRated();
                        }
                      });
