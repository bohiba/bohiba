                            ...
                            children: [
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Spacer(),
                                        Visibility(
                                          visible: controller.driverModel.value
                                                      ?.profile ==
                                                  null
                                              ? false
                                              : true,
                              ...
                              Visibility(
                                visible: controller.driverModel.value?.rating ==
                                            null ||
                                        (controller.driverModel.value?.rating
                                                ?.isEmpty ??
                                            false)
                                    ? false
                                    : true,
              ...
              if (controller.didReviewed.value == true ||
                ...
                Padding(
                  ...
                  child: PrimaryButton(
                    onPressed: () {
                      navigate
                          .pushNamed(AppRoute.ratingDriver,
                              arguments: controller.driverModel)
                          .then((onValue) {
                        if (onValue != null) {
                          controller.isRated();
                        }
