              ...
              child: Column(
                ...
                children: [
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      controller.openDriver.value.profile
                                              ?.driverUuid ??
                                          '',
                  ...
                  LinearBoxWidget(
                    ...
                    title: controller.openDriver.value.profile?.isActive
                            ?.capitalizeFirst ??
                        '',
                  ),
                  LinearBoxWidget(
                  ...
                  LinearBoxWidget(
                    ...
                    title: controller
                            .openDriver.value.licenseDetail?.licenseNumber ??
                        '',
                  ),
                  LinearBoxWidget(
                    header: 'License Status',
                    title: controller.openDriver.value.licenseDetail?.status
                            ?.capitalizeFirst ??
                        '',
                  ),
                  LinearBoxWidget(
                    header: 'COV',
                    title: controller.openDriver.value.licenseDetail?.cov
                            ?.toUpperCase() ??
                        '',
                  ),
                  LinearBoxWidget(
                      header: 'Issued',
                      title: controller
                              .openDriver.value.licenseDetail?.validityFrom ??
                          ''),
                  LinearBoxWidget(
                    header: 'Expiry',
                    title: controller
                            .openDriver.value.licenseDetail?.validityTill ??
                        '',
                  ),
