          ...
          child: Padding(
            ...
            child: SmartRefresher(
              ...
              child: SingleChildScrollView(
                child: (controller.jobObj.value.id == null)
                    ? SizedBox.shrink()
                    : Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(
                            controller.jobObj.value.jobTitle ?? '',
                            maxLines: 2,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                " ${(controller.jobObj.value.location ?? '').toString().toUpperCase()}",
                                style: TextStyle(
                                  fontSize:
                              ...
                              Text(
                                ' ${(controller.jobObj.value.jobType ?? '').toString().toUpperCase()}',
                                style: TextStyle(
                                  fontSize:
                                      bohibaTheme.textTheme.bodyLarge!.fontSize,
                                  fontWeight: bohibaTheme
                          ...
                          RoleWidget(
                            driverWidget: LinearBoxWidget(
                              header: 'Status',
                              title: controller.jobStatus.value
                                  .toCapitalizedLabel(),
                            ),
                              ...
                              widget: DropdownButtonHideUnderline(
                                child: DropdownButton<String>(
                                  value: controller.statusItem.contains(
                                          controller.jobObj.value.status)
                                      ? controller.jobObj.value.status
                                      : null,
                                  isDense: true,
                          ...
                          LinearBoxWidget(
                            header: 'Truck Number',
                            title: controller.jobObj.value.regdNumber
                                .toString()
                                .toUpperCase(),
                          ),
                          LinearBoxWidget(
                            header: 'Last Updated',
                            title: controller.jobObj.value.updatedAt.toString(),
                          ),
                          LinearBoxWidget(
                            header: 'Created At',
                            title: controller.jobObj.value.createdAt.toString(),
                          ),
                          Padding(
                          ...
                          ReadMoreText(
                            controller.jobObj.value.description.toString(),
                            trimLines: 5,
