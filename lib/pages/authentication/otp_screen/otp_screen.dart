import 'package:bohiba/dist/enums/enum_otp_verification.dart';
                      ...
                      onPressed: () async {
                        switch (controller.otpPurpose) {
                          ...
                          case OtpPurpose.createUser:
                            String succesValidate =
                                await controller.verifyOtp();
                            if (succesValidate.toLowerCase() ==
                                EnumOtpVerification.verified.name) {
                            ...
                            } else if (succesValidate.toLowerCase() ==
                                EnumOtpVerification.restored.name) {
